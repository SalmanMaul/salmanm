...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2022 at 04:47 AM
...
(3, 'Gym', 'Bagi anda yang suka berolahraga, Kami manajemen Hotel Mercure juga Menyediakan fasilitas olahraga dan gym, sehingga client juga bisa berolahraga di hotel tanpa harus capek pergi keluar sekedar mencari tempat GYM, dan juga berolahraga di GYM hotel Kiyowo juga sangat menyenangkan karena sambil berolahraga juga bisa sambil menikmati sunset di Penghujung senja.', 'gym.jpg'),
(4, 'Ruang Temu Bisnis', 'Menyediakan Ruang temu yang sangat mewah, dan bisa di desain juga, ruang ini berguna sebagai tampat mengadakan acara rapat bisnis yang di lakukan oleh pengusaha - pengusaha besar, dan sebagai acara lainnya juga. sehingga tidak rugi deh bagi para pebisnis atau pengusaha melakukan rapat penting mereka di Hotel Kiyowo.', 'ruang temu.jpg'),
(5, 'Spa', 'Hotel Kiyowo Menyediakan fasilitas SPA bagi para perempuan yang ingin tampil lebih cantik dan memanjakan diri mereka, selain itu petugas SPA juga sangat ramah serta produk yang pakai di SPA Hotel Kiyowo di bawah perlindungan dokter kecantikan, jadi di jamin aman untuk kulit client.', 'spa.jpg');
...
(3, 'Salman Maulana', 'salman', 'salman', '087802522783', 'Pria', 'KP Cibeber Hilir', 'salman.maulana2004@gmail.com');
...
INSERT INTO `resepsionis` (`id_user`, `nama`, `username`, `password`) VALUES
(1, 'Resepsionis', 'resepsionis', '3aeff485f68b360d076de3d73f9247ad');
...
(1, 'kiyowo1.jpg', 'Welcome To Kiyowo Hotel', 'Hotel &amp; Resort'),
(2, 'kiyowo2.JPG', 'Pemandangan Indah Menanti', 'Join with Us!'),
(3, 'kiyowo3.JPG', 'Ruangan Yang Nyaman', 'Pesan DImanapun, & Kapanpun');
...
(2, 'staff4.jpg', 'Salman Maulana', 'Menjabat Direktur Hotel Kiyowo'),
(3, 'staff5.jpg', 'Yohanes Soni Haliman', 'staff husus Bagian IT Hotel Kiyowo'),
(4, 'staff1.jpg', 'Siti Nurhaliza', 'menjabat sebagai Resepsionis\r\n'),
(5, 'staff2.jpg', 'Celine Saputri', 'kepala chef Hotel Kiyowo'),
...
('2', 'Shelly Asali', 'Jakarta pusat', 'Jakarta', '082389132607', 'perempuan'),
('3', 'Yonaldo', 'bukittinggi', 'Jakarta', '082389132608', 'Laki Laki'),
('4', 'Rido', 'padang', 'Solok', '082389132609', 'Laki Laki'),
('5', 'ihsan', 'jakarta', 'jakarta', '08665732561', 'Laki-Laki');
...
('623ff6cfb3a81', '003', '1', '2022-03-29', '2022-03-30', 1, '100000', 'afri yulianti', '082389132606', 'shellyasali@gmail.com', 'tidak adaa'),
('62411df8b7964', '001', '1', '2022-03-29', '2022-03-30', 1, '250000', 'afri yulianti', '082389132606', 'shellyasali@gmail.com', 'dsd');
